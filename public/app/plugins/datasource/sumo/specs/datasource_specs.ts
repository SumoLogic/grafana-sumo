...
describe('SumoDatasource', function() {
  ...
  describe('When querying with one target using query editor target spec', function() {
    var results;
  ...
  describe('When querying with one target which return multiple series', function() {
    var results;
